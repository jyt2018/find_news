...
def parse_articles(article_item_node, article_meta_conf, c_tag):
    """解析文章条目节点，提取文章条目信息，使用配置文件定义提取规则"""
    ...
    # 查找所有 article 容器
    # article_item_node is a single article with html tags, type is bs4.element.Tag
    article = {}
...
if __name__ == '__main__':
    html = open('tools/index.html', 'r', encoding='utf-8').read()    
    config_path = 'tools/scrapy_cfg.json'
    c_tag = 'autonomous'
    ...
    print(article_item_conf)
    print(article_meta_conf, "\n")
